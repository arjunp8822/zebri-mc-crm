    ...
    <section className="py-20 px-4 md:py-32 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-24 md:space-y-32">
          {/* 1. Timeline Builder — text left, mock right */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-base text-gray-500 leading-relaxed mb-4">
                Drag-and-drop timeline synced with the couple. Edit on the fly. Everyone sees the same schedule — no more &ldquo;wait, what time is first dance?&rdquo; messages.
              </p>
          ...
          {/* 2. Couple Portal — mock left, text right (ALTERNATED) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span>Pronunciation guides included</span>
              </div>
            </div>
          </div>

          {/* 3. Script Organiser — text left, mock right */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              <div className="w-10 h-10 rounded-lg bg-violet-50 border border-violet-100 flex items-center justify-center mb-5">
          ...
          {/* 4. On-The-Night Mode — mock left, text right (ALTERNATED) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              <NightModeMock />
            </div>
            <div className="order-1 lg:order-2">
              <div className="w-10 h-10 rounded-lg bg-gray-800 border border-gray-700 flex items-center justify-center mb-5">
...
function TimelineMock() {
  const items = [
    ...
    { time: "7:00 PM", event: "Reception entrance", status: "upcoming" as const },
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-lg shadow-gray-100/80">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-[10px] text-gray-400">5 items</span>
      </div>
        ...
        {items.map((item, i) => (
          ...
          >
            <div className={`w-2 h-2 rounded-full flex-shrink-0 ${
              item.status === "current" ? "bg-blue-500" : item.status === "done" ? "bg-gray-300" : "bg-gray-200"
            }`} />
            <span className={`font-mono text-[11px] w-14 flex-shrink-0 ${
              item.status === "current" ? "text-blue-600 font-semibold" : "text-gray-400"
            }`}>
              {item.time}
            </span>
            <span className={`flex-1 text-[13px] ${
              item.status === "current" ? "text-blue-800 font-semibold" : item.status === "done" ? "text-gray-400 line-through" : "text-gray-700"
            }`}>
              {item.event}
            </span>
            {/* 6-dot drag handle */}
            <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" className="text-gray-200 group-hover:text-gray-400 cursor-grab flex-shrink-0 transition-colors">
...
function CouplePortalMock() {
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-lg shadow-gray-100/80">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /></svg>
          <span className="text-xs font-semibold text-gray-700">Couple Details</span>
        </div>
        <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[10px] font-semibold rounded-full border border-emerald-100">Complete</span>
      </div>
      <div className="space-y-3.5">
        <div>
          <label className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider block mb-1.5">Bride &amp; Groom</label>
        ...
        <div>
          ...
          <div className="space-y-1.5">
            {[
              { name: "Emma Chen", role: "Maid of Honor" },
              { name: "Jessica Williams", role: "Sister of Groom" },
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white shadow-lg shadow-gray-100/80 overflow-hidden">
      <div className="px-5 pt-5 pb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8B5CF6" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z" /><polyline points="14 2 14 8 20 8" /></svg>
          <span className="text-xs font-semibold text-gray-700">Scripts</span>
        </div>
        <span className="text-[10px] text-gray-400">Chen &amp; Williams</span>
      </div>
      ...
      <div className="border-t border-gray-100">
        ...
        <div className="border-b border-gray-100">
          <div className="flex items-center gap-2 px-5 py-3 cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <span className="text-[10px] text-gray-400 ml-auto">2 min read</span>
          </div>
          <div className="px-5 pb-4 pl-9">
            <p className="text-[12px] text-gray-500 leading-relaxed">
              &ldquo;Good evening, everyone. My name is [Your Name], and it is an absolute honour to be your MC tonight for the wedding of Sarah and Tom.&rdquo;
            </p>
            <p className="text-[12px] text-gray-400 leading-relaxed mt-2">
              &ldquo;Before we get started, I want to acknowledge the Chen and Williams families for bringing us all together...&rdquo;
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 px-5 py-3 cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <span className="text-[10px] text-gray-400 ml-auto">1 min read</span>
          </div>
        </div>
      </div>
    </div>
...
function NightModeMock() {
  return (
    <div className="rounded-lg overflow-hidden shadow-xl shadow-gray-900/20 bg-gray-900 border border-gray-800">
      {/* Status bar */}
      <div className="flex items-center justify-between px-5 py-2 border-b border-gray-800">
        ...
        <span className="text-[10px] text-gray-500 font-mono">8:42 PM</span>
      </div>

      {/* Current item */}
      <div className="px-6 py-6">
        <p className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold mb-2">Now</p>
        <h4 className="text-3xl font-bold text-white mb-1">First Dance</h4>
        <p className="text-sm text-gray-500">Sarah &amp; Tom &middot; &ldquo;At Last&rdquo; by Etta James</p>
      ...
      <div className="px-6 pb-5 pt-2">
        <div className="border-t border-gray-800 pt-4">
          <p className="text-[10px] text-gray-600 uppercase tracking-wider font-semibold mb-2">Next Up</p>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-semibold text-gray-300">Toasts &amp; Speeches</p>
              <p className="text-[11px] text-gray-600 mt-0.5">Best man, then maid of honor</p>
            </div>
            <span className="text-xs font-mono text-gray-500 bg-gray-800 px-2 py-1 rounded">8:55 PM</span>
          </div>
        </div>
      </div>
    </div>
