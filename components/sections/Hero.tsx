            ...
            <div className="pt-2">
              <form className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3.5 border border-gray-200 rounded-md text-sm text-gray-900 bg-white placeholder:text-gray-400 outline-none transition-all focus:border-gray-900 focus:ring-2 focus:ring-gray-900/5"
                />
                <button
                  type="submit"
                  className="px-7 py-3.5 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-md text-sm whitespace-nowrap transition-colors"
                >
                  Claim Your Spot
                </button>
              </form>
    ...
    <div className="rounded-lg border border-gray-200 overflow-hidden shadow-xl shadow-gray-200/60 bg-white">
      ...
      <div className="flex">
        ...
        <div className="w-40 border-r border-gray-100 bg-gray-50/50 p-3 space-y-1 hidden xl:block">
          {[
            { label: "Overview", active: false, iconPath: "M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3zM14 14h7v7h-7z" },
            { label: "Timeline", active: true, iconPath: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM12 6v6l4 2" },
            { label: "Scripts", active: false, iconPath: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z" },
            { label: "Couple", active: false, iconPath: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" },
          ].map((item, i) => (
            <div
              key={i}
              ...
              {[
                ...
                >
                  ...
                  <span className={`flex-1 truncate ${
                    item.status === "current" ? "font-semibold" : item.status === "done" ? "text-gray-400 line-through" : "text-gray-700"
                  }`}>
                    {item.event}
                  </span>
